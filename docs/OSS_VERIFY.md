...
候选包在预发布 https://github.com/diankourenxia/wodeappx/releases/tag/ci-packages-1.0.0 （Actions artifact 配额常满，以 Release 为准）。Win exe / Linux tar.gz 本机 asar smoke PASS。
