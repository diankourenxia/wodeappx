...
import {
  ...
  startBridge,
} from "./wodeappx-browser-control-runtime.mjs";
import {
...
export default async ({ client }: any = {}) => {
  ...
  return {
    tool: {
      ...
      wodeappx_browser_open_url: tool({
      ...
      wodeappx_browser_read_page: tool({
      ...
      wodeappx_browser_screenshot: tool({
