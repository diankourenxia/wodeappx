...
import { getWodeAppPlazaSnapshot, listPlazaSkinDefinitions, subscribeWodeAppPlaza } from "./wodeapp-plaza";
...
export function WodeAppSkinPickerDialog({
  ...
  const plazaStamp = React.useSyncExternalStore(
    subscribeWodeAppPlaza,
    getWodeAppPlazaSnapshot,
    getWodeAppPlazaSnapshot,
  );
  const pickerSkins = React.useMemo(
    () => [...listVisibleWodeAppSkins(), ...listPlazaSkinDefinitions()],
    [plazaStamp],
  );
