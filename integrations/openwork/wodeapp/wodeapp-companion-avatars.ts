...
const SKIN_PERCH_DEFAULT: Record<string, string> = {
  ...
  "summer-breeze": "perch-dolphin",
  "aurora-night": "perch-fox",
  "forest-mist": "perch-owl",
  "coffee-loft": "perch-cat",
};
...
export const WODEAPP_FLOAT_COMPANION_AVATARS: readonly WodeAppCompanionAvatar[] = [
  ...
  },
  {
    ...
    kind: "sprite",
    label: "小海豚",
    spriteSheet: "companion-dolphin-sprite-sheet.png",
    frames: 4,
  },
  {
    id: "fox",
    kind: "sprite",
    label: "极光狐",
    spriteSheet: "companion-fox-sprite-sheet.png",
    frames: 4,
  },
  {
    id: "owl",
    kind: "sprite",
    label: "林间猫头鹰",
    spriteSheet: "companion-owl-sprite-sheet.png",
    frames: 4,
  },
  {
    id: "xiaoxue",
...
export const WODEAPP_PERCH_COMPANION_AVATARS: readonly WodeAppCompanionAvatar[] = [
  ...
  },
  {
    ...
    kind: "sprite",
    label: "探头海豚",
    spriteSheet: "companion-perch-dolphin-sheet.png",
    frames: 4,
  },
  {
    id: "perch-fox",
    kind: "sprite",
    label: "探头极光狐",
    spriteSheet: "companion-perch-fox-sheet.png",
    frames: 4,
  },
  {
    id: "perch-owl",
    kind: "sprite",
    label: "探头猫头鹰",
    spriteSheet: "companion-perch-owl-sheet.png",
    frames: 4,
  },
] as const;
