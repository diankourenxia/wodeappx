...
export const WODEAPP_SKIN_COMPANION_KIT: Record<string, WodeAppSkinCompanionKit> = {
  ...
  "summer-breeze": { floatAvatarId: "dolphin", perchAvatarId: "perch-dolphin" },
  "aurora-night": { floatAvatarId: "fox", perchAvatarId: "perch-fox" },
  "forest-mist": { floatAvatarId: "owl", perchAvatarId: "perch-owl" },
  "coffee-loft": { floatAvatarId: "cat", perchAvatarId: "perch-cat" },
};
