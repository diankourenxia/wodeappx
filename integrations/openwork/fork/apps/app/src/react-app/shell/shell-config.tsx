...
import { resolveWodeAppEdition } from "@/react-app/domains/wodeapp/wodeapp-edition";
...
export type ShellConfig = {
  ...
  /** WodeAppX workbench sidebar (replaces OpenWork AppSidebar). */
...
const EDITION = resolveWodeAppEdition();

export const DEFAULT_SHELL_CONFIG: ShellConfig = {
  appName: EDITION.productName,
  statusBar: false,
  sidebar: false,
  docsButton: true,
  feedbackButton: true,
  cloudSignin: EDITION.defaultCloudSignin,
  welcomePage: false,
  starterCards: true,
  modelPicker: true,
  browser: true,
...
const STORAGE_KEY = "wodeappx.shell-config";
const LEGACY_STORAGE_KEY = "openwork.shell-config";
...
function readShellConfig(): ShellConfig {
  ...
  try {
    ...
    const parsed = JSON.parse(raw) as Partial<ShellConfig>;
    return {
      ...DEFAULT_SHELL_CONFIG,
      ...parsed,
      appName: DEFAULT_SHELL_CONFIG.appName,
      wodeappWorkbench: true,
      welcomePage: false,
      statusBar: false,
      sidebar: false,
